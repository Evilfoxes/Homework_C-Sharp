...
// Например, в массиве [3, 9, -8, 1, 0, 2, -1, 8, -3, -1, 6] сумма
...
Console.WriteLine($"Sum positive element = {sumPositiveNegativeElem[0]}");
Console.WriteLine($"Sum negative element = {sumPositiveNegativeElem[1]}");

int sumPositiveElem = SumPositiveElem(array);
int sumNegativeElem = SumNegativeElem(array);
Console.WriteLine($"Sum positive element = {sumPositiveElem}");
Console.WriteLine($"Sum negative element = {sumNegativeElem}");